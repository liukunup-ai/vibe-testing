...
const UpdateForm = ({ visible, onCancel, onSuccess, initialValues }: UpdateFormProps) => {
  ...
  return (
    <Modal
      title={
        <FormattedMessage id="pages.admin.role.modal.updateForm.title" defaultMessage="编辑角色" />
      }
      open={visible}
      onOk={handleOk}
    ...
    >
      <Form form={form} layout="vertical" className="update-role-form">
        ...
        <Form.Item
          ...
          rules={[
            ...
            },
            {
              max: 20,
              message: intl.formatMessage({
                id: 'pages.admin.role.form.name.maxlen',
        ...
        >
          <Input
            placeholder={intl.formatMessage({
              id: 'pages.admin.role.form.name.placeholder',
              defaultMessage: '请输入角色的名称',
            })}
          />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            ...
            },
            {
              max: 20,
              message: intl.formatMessage({
                id: 'pages.admin.role.form.role.maxlen',
                defaultMessage: '标识不能超过20个字符',
              }),
            },
            {
              pattern: /^[a-zA-Z][a-zA-Z0-9]*$/,
              message: intl.formatMessage({
                id: 'pages.admin.role.form.role.pattern',
        ...
        >
          <Input
            placeholder={intl.formatMessage({
              id: 'pages.admin.role.form.role.placeholder',
              defaultMessage: '请输入角色的标识',
            })}
            disabled
          />
        </Form.Item>
